    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <h3 class="mb-0 text-culture-green">
                <i class="bi bi-pin-map-fill me-2"></i>Ajouter une Région
            </h3>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-end mb-0">
                ...
                <li class="breadcrumb-item active text-culture-green" aria-current="page">Nouvelle Région</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.regions.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Ville , Village, Département..."
                                   required>
                        </div>
                        @error('nom_region')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                 ...
                                 name="description" 
                                 rows="4" 
                                 placeholder="Description de cette zone géographique ou administrative...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
